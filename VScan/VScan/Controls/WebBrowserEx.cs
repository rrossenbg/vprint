...
namespace PremierTaxFree.Controls
{
    ...
    ////{
    ////WebBrowserEx wb = (WebBrowserEx)sender;
    ////wb.Zoom(m_ZoomFactor);
    ////}
    ...
    public class WebBrowserEx : WebBrowser
    {
        ...
        public void Zoom(int factor)
        {
            ...
            try
            {
                this.axIWebBrowser2.ExecWB(OLECMDID.OLECMDID_OPTICAL_ZOOM, OLECMDEXECOPT.OLECMDEXECOPT_DONTPROMPTUSER, 
