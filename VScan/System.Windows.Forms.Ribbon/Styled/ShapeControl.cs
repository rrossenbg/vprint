...
namespace System.Windows.Forms.Styled
{
    ...
    /// </summary>
    /// <see cref="http://www.codeproject.com/KB/miscctrl/ShapeControldotNET.aspx"/>
    public class ShapeControl : DockableUserControl
    {
        ...
        [BrowsableAttribute(true)]
        [EditorAttribute(typeof(ShapeTypeEditor), typeof(UITypeEditor))]
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (_usegradient)
            {
                using (PathGradientBrush br = new PathGradientBrush(this._outline))
                {
                ...
                switch (_shape)
                {
                    ...
                    case ShapeType.BallonNW:
                        pe.Graphics.DrawString(this.Text, this.Font,
                            ...
                            new RectangleF(0, this.Height * 0.25f, this.Width, this.Height * 0.75f), sf);
                        break;
                    ...
                    case ShapeType.BallonSW:
                        pe.Graphics.DrawString(this.Text, this.Font,
                            new SolidBrush(this.ForeColor),
                            new RectangleF(0, 0, this.Width, this.Height * 0.75f), sf);
                        break;
