...
namespace CPrint2.AuthenticationRef {
    ...
    public interface AuthenticationSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CPrint2.AuthenticationRef.RetrieveUserResponse RetrieveUser(CPrint2.AuthenticationRef.RetrieveUserRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CPrint2.AuthenticationRef.CreateUserResponse CreateUser(CPrint2.AuthenticationRef.CreateUserRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CPrint2.AuthenticationRef.EncryptPasswordResponse EncryptPassword(CPrint2.AuthenticationRef.EncryptPasswordRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CPrint2.AuthenticationRef.DecryptPasswordResponse DecryptPassword(CPrint2.AuthenticationRef.DecryptPasswordRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CPrint2.AuthenticationRef.GenerateSaltResponse GenerateSalt(CPrint2.AuthenticationRef.GenerateSaltRequest request);
    }
    ...
    public partial class RetrieveUserRequest {
        ...
        public CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader;
        ...
        public RetrieveUserRequest(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader, int countryId, string userName) {
    ...
    public partial class CreateUserRequest {
        ...
        public CreateUserRequest(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader, int countryId, string userName, string password) {
            this.AuthenticationHeader = AuthenticationHeader;
            this.countryId = countryId;
            this.userName = userName;
    ...
    public partial class EncryptPasswordRequest {
        ...
        public EncryptPasswordRequest(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader, string password, string salt) {
            this.AuthenticationHeader = AuthenticationHeader;
            this.password = password;
            this.salt = salt;
        }
    ...
    public partial class DecryptPasswordRequest {
        ...
        public DecryptPasswordRequest(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader, string encryptedPassword, string salt) {
            this.AuthenticationHeader = AuthenticationHeader;
    ...
    public partial class GenerateSaltRequest {
        ...
        public GenerateSaltRequest(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader) {
            this.AuthenticationHeader = AuthenticationHeader;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AuthenticationSoapChannel : CPrint2.AuthenticationRef.AuthenticationSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthenticationSoapClient : System.ServiceModel.ClientBase<CPrint2.AuthenticationRef.AuthenticationSoap>, CPrint2.AuthenticationRef.AuthenticationSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPrint2.AuthenticationRef.DecryptPasswordResponse CPrint2.AuthenticationRef.AuthenticationSoap.DecryptPassword(CPrint2.AuthenticationRef.DecryptPasswordRequest request) {
            return base.Channel.DecryptPassword(request);
        }
        
        public string DecryptPassword(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader, string encryptedPassword, string salt) {
            CPrint2.AuthenticationRef.DecryptPasswordRequest inValue = new CPrint2.AuthenticationRef.DecryptPasswordRequest();
            inValue.AuthenticationHeader = AuthenticationHeader;
            inValue.encryptedPassword = encryptedPassword;
            inValue.salt = salt;
            CPrint2.AuthenticationRef.DecryptPasswordResponse retVal = ((CPrint2.AuthenticationRef.AuthenticationSoap)(this)).DecryptPassword(inValue);
            return retVal.DecryptPasswordResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CPrint2.AuthenticationRef.GenerateSaltResponse CPrint2.AuthenticationRef.AuthenticationSoap.GenerateSalt(CPrint2.AuthenticationRef.GenerateSaltRequest request) {
            return base.Channel.GenerateSalt(request);
        }
        
        public string GenerateSalt(CPrint2.AuthenticationRef.AuthenticationHeader AuthenticationHeader) {
            CPrint2.AuthenticationRef.GenerateSaltRequest inValue = new CPrint2.AuthenticationRef.GenerateSaltRequest();
            inValue.AuthenticationHeader = AuthenticationHeader;
            CPrint2.AuthenticationRef.GenerateSaltResponse retVal = ((CPrint2.AuthenticationRef.AuthenticationSoap)(this)).GenerateSalt(inValue);
