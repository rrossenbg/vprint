...
namespace VPrinting.Colections
{
    ...
    public class SortableBindingList<T> : BindingList<T> where T : class
    {
        ...
        protected override void ApplySortCore(PropertyDescriptor prop, ListSortDirection direction)
        {
            ...
            if (list == null) 
                throw new ArgumentException("Inner collection should be List");
        ...
        {
            object lhsValue = lhs == null ? null : m_sortProperty.GetValue(lhs);
            object rhsValue = rhs == null ? null : m_sortProperty.GetValue(rhs);
            if (lhsValue == null)
            {
