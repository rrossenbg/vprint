...
namespace FintraxServiceManager
{
    public class FintraxServiceManager : ServiceBase
    {
        ...
        public ThreadExceptionEventHandler LogErrorDelegate;
        ...
        public void ThreadWorker_Error(object sender, ThreadExceptionEventArgs e)
        {
            EventLog.WriteEntrySf(e.Exception.ToString(), EventLogEntryType.Error);
            EventLog.WriteEntrySf(e.Exception.Data.ToStr(), EventLogEntryType.Error);
