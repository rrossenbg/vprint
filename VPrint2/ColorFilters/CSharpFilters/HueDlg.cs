...
{
	/// <summary>
	/// Summary description for HueDlg.
	/// </summary>
	public class HueDlg : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.OK.Location = new System.Drawing.Point(576, 512);
			this.OK.Name = "OK";
			...
			// Luminance
			// 
			this.Luminance.Location = new System.Drawing.Point(32, 528);
			...
			// setLuminance
			// 
			this.setLuminance.Location = new System.Drawing.Point(112, 504);
			...
			// label1
			// 
			this.label1.Location = new System.Drawing.Point(32, 504);
		...
		private void OnChange(object sender, System.EventArgs e)
		{
			...
			dest = ColorSpace.Hue(src, luminance);
