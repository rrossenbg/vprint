...
namespace VPrintTest
{
    ...
    public class UruguayTest
    {
        ...
        public void uruguay_print_format_Type_1_Live()
        {
            ...
            printer.m_PrinterXmlFilePath = @"C:\PROJECTS\VPrint2\XmlConfigurations\print858_Type1.xml";
            //5 MUNDOS, LDA
