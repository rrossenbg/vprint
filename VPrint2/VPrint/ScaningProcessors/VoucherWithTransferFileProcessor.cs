...
{
    public class VoucherWithTransferFileProcessor : IScanProcessor
    {
        private const int TRIES = 10;

        public static readonly VoucherWithTransferFileProcessor Default = new VoucherWithTransferFileProcessor();
