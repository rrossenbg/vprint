...
{
    public class VoucherWithBarcodeAndNoDocumentProcessor : IScanProcessor
    {
        private const int TRIES = 10;

        public static VoucherWithBarcodeAndNoDocumentProcessor Default = new VoucherWithBarcodeAndNoDocumentProcessor();
