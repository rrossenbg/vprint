...
namespace VPrinting.Documents
{
    ...
    /// </example>
    public partial class VoucherPrinter : VoucherPrinterSettings, IDataProvider, IDisposable
    {
        ...
        public static RepeaterCounter Repeat { get; set; }
